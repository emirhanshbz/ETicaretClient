...
const routes: Routes = [
  { //admin
    path: "admin", component: LayoutComponent, children: [
      { path:"", component: DashboardComponent, canActivate: [AuthGuard] }, //https://....com/admin sayfası için varsayılan sayfayı dashboard yaptık

      { path: "customers", loadChildren: () => import("./admin/components/customer/customer.module").then
      (module => module.CustomerModule), canActivate: [AuthGuard] },  //https://....com/admin/customers e bir istek geliyorsa bu modülde ara
    ...
    ], canActivate: [AuthGuard] // admin sayfasına erişim için auth guard'ı kullanıyoruz
  },
  //ui
