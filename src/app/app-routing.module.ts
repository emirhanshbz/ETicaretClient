...
const routes: Routes = [
  {
    path: "admin", component: LayoutComponent, children: [
      { path:"", component: DashboardComponent }, //https://....com/admin sayfası için varsayılan sayfayı dashboard yaptık

      { path: "customers", loadChildren: () => import("./admin/components/customer/customer.module").then
      (module => module.CustomerModule) },  //https://....com/admin/customers e bir istek geliyorsa bu modülde ara
